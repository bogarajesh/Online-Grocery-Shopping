...
public class Thumbsup extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Thumbsup.this, AddCart.class);
                Toast.makeText(Thumbsup.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
