...
public class Nutrichoice extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nutrichoice);
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Nutrichoice.this, AddCart.class);
                Toast.makeText(Nutrichoice.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
