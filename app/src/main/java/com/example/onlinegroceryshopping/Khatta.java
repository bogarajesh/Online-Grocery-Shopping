...
public class Khatta extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_khatta);
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Khatta.this, AddCart.class);
                Toast.makeText(Khatta.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
