...
public class Murukku extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_murukku);
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Murukku.this, AddCart.class);
                Toast.makeText(Murukku.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
