...
public class DairyMilk extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dairy_milk);
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(DairyMilk.this, AddCart.class);
                Toast.makeText(DairyMilk.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
