...
public class DarkFantasy extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dark_fantasy);
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(DarkFantasy.this, AddCart.class);
                Toast.makeText(DarkFantasy.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
