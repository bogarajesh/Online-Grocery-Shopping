...
public class ButterCookies extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_butter_cookies);
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(ButterCookies.this, AddCart.class);
                Toast.makeText(ButterCookies.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
