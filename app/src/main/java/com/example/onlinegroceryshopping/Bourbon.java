...
public class Bourbon extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bourbon);
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Bourbon.this, AddCart.class);
                Toast.makeText(Bourbon.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
