...
public class CreamOnion extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cream_onion);
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(CreamOnion.this, AddCart.class);
                Toast.makeText(CreamOnion.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
