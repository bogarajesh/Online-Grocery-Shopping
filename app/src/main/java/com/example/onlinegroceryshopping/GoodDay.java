...
public class GoodDay extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(GoodDay.this, AddCart.class);
                Toast.makeText(GoodDay.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
