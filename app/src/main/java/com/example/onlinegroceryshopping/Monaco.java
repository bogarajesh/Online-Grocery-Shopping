...
public class Monaco extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Monaco.this, AddCart.class);
                Toast.makeText(Monaco.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
