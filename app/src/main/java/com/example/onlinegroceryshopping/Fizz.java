...
public class Fizz extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Fizz.this, AddCart.class);
                Toast.makeText(Fizz.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
