...
public class Sev extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Sev.this, AddCart.class);
                Toast.makeText(Sev.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
