...
public class Munch extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Munch.this, AddCart.class);
                Toast.makeText(Munch.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
