...
public class MarieLight extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_marie_light);
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MarieLight.this, AddCart.class);
                Toast.makeText(MarieLight.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
