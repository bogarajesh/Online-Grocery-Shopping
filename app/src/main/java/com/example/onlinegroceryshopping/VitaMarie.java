...
public class VitaMarie extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vita_marie);
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(VitaMarie.this, AddCart.class);
                Toast.makeText(VitaMarie.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
