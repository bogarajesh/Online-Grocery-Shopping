...
public class Nariyal extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nariyal);
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Nariyal.this, AddCart.class);
                Toast.makeText(Nariyal.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
