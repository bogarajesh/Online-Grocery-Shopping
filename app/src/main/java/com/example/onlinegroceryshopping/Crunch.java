...
public class Crunch extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Button btnaddcart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnaddcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Crunch.this, AddCart.class);
                Toast.makeText(Crunch.this, "Added", Toast.LENGTH_SHORT).show();
                startActivity(i);
            }
        });
